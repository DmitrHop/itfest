...
// Based on the file structure: assets/3d-models/[university]/[location]/[image].png
const ALL_LOCATIONS = {
    iitu: [
        {
            id: 'hall',
    ...
    narxoz: [
        {
            ...
            texturePath: '/assets/3d-models/Narxoz/hall/1.png',
        },
        {
            id: 'hub',
            name: 'Student Hub',
            description: 'Coworking and relaxation area',
            texturePath: '/assets/3d-models/Narxoz/hub/1.png',
        }
    ],
    aues: [
        {
