...
const PredictionCard = ({ item, onSelectUni, onClose }: { item: GrantPrediction, onSelectUni: (u: University) => void, onClose: () => void }) => {
  ...
  <div className="group bg-white rounded-2xl shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-300 border border-slate-100 overflow-hidden flex flex-col h-full relative">
    <button 
      ...
      className={`absolute top-3 right-3 z-10 p-2 rounded-full backdrop-blur-md transition-all ${
        isFavorite ? 'bg-red-50 text-red-500 shadow-sm' : 'bg-white/30 text-white hover:bg-white hover:text-red-500'
      }`}
    >
